...
const byte MATRIX_WIDTH  =  10;                                    // NA Not used in thsi clock. 10 is fine 
const byte MATRIX_HEIGHT =  10;                                    // NA Not used in thsi clock. 10 is fine 
